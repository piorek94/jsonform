...
The libraries in the ```opt``` subfolder are optional as long as you do not use the feature they enable:
  ...
  * [validator](opt/validator):
    ...
    - [jquery-validation](https://jqueryvalidation.org/): jQuery Validation Plugin is used to detect and report validation errors related to form upon form submission. The [opt/validator/jquery-validation](opt/validator/jquery-validation) folder contains all required files to use it in JSON Form.
