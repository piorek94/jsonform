...
jsonform.elementTypes = {
  ...
  'radios':{
    'template': '<div id="<%= node.id %>"<% if (elt.inline) { %> class="<%= cls.formInlineClass %>"<% } %>>' +
      ...
      '<div class="form-check<% if (elt.inline) { %> form-check-inline<% } %>">' +
        '<input ' +
  ...
  'checkboxes':{
    ...
    'childTemplate': function(inner, node) {
      ...
      if (!node.formElement.otherField)
        return inner;
      // wrapping div begin
      var template = '<div class="form-check' + (node.formElement.inline ? ' form-check-inline' : '') + (node.formElement.otherField.inline ? ' inline-' : ' ') + 'other-field">';
    ...
    'onBeforeRender': function (data, node) {
      ...
      var template = '<div class="form-check' + (node.formElement.inline ? " form-check-inline" : "") + '">' +
        '<input ' +
    ...
    'onBeforeRender': function (data, node) {
      ...
      _.each(node.children, function (child, idx) {
        ...
        tab_list += '<li class="nav-item' +
          ((idx === 0) ? ' active' : '') + '">' +
          '<a href="#'+ parentID + title_escaped +'" class="tab nav-link' + ((idx === 0) ? ' active' : '') + '"' +
