...
formTree.prototype.initialize = function (formDesc) {
  ...
  var isSimpleRootSchema = function (schema) {
    ...
    if (schema.type) {
      if (_.isString(schema.type) && schema.type === 'object') {
        return false;
      } else if (Array.isArray(schema.type) && _.contains(schemaElement.type, 'object')) {
        return false;
      }
    }
    return true;
  ...
  if (this.formDesc.schema && isSimpleRootSchema(this.formDesc.schema) === true) {
    ...
    this.formDesc.schema.properties[this.formDesc.prefix + '-distortedSchema'] = distortedSchema;
