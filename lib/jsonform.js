...
jsonform.elementTypes = {
  ...
  'array': {
    ...
    'onInsert': function (evt, node) {
      ...
      $nodeid
        .off('click', '> span > a._jsonform-array-addmore')
        .on('click', '> span > a._jsonform-array-addmore', function (evt) {
  ...
  'tabarray': {
    ...
    'onInsert': function (evt, node) {
      ...
      var deleteItem = function (idx) {
        ...
        $nodeid.find('> .jsonform-tabbable > .nav-tabs > li > ._jsonform-array-addmore')
          .toggleClass('disabled', boundaries.maxItems >= 0 && node.children.length >= boundaries.maxItems);
      }
      ...
      $nodeid
        .off("click", '> .jsonform-tabbable > .nav-tabs > li > ._jsonform-array-addmore')
        .on('click', '> .jsonform-tabbable > .nav-tabs > li > ._jsonform-array-addmore', function (evt) {
        var idx = node.children.length;
        evt.preventDefault();
        evt.stopPropagation();
        addItem(idx);
