...
jsonform.elementTypes = {
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<% if (!node.isReadOnly()) { %><span class="_jsonform-array-buttons">' +
        '<a href="#" class="<%= cls.buttonClass %> _jsonform-array-addmore"><i class="<%= cls.iconClassPrefix %>-plus" title="<%= node.formElement.addMoreTooltip ? escape(node.formElement.addMoreTooltip) : \'Add new item\'%>"></i> <%= node.formElement.addMoreTitle || \'\'%></a> ' +
      '</span><% } %>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
    ...
    'onInsert': function (evt, node) {
      ...
      $('> span > a._jsonform-array-addmore', $nodeid).off("click").on("click", function (evt) {
        evt.preventDefault();
        evt.stopPropagation();
      ...
      $nodeid
        .off('click', '> ul > li > a._jsonform-array-item-delete')
        .on('click', '> ul > li > a._jsonform-array-item-delete', function (e) {
        e.preventDefault();
  ...
  'tabarray': {
    ...
    'onInsert': function (evt, node) {
      ...
      $nodeid
        .off("click", '> a._jsonform-array-addmore, > .jsonform-tabbable > .nav-tabs > li > ._jsonform-array-addmore')
        .on('click', '> a._jsonform-array-addmore, > .jsonform-tabbable > .nav-tabs > li > ._jsonform-array-addmore', function (evt) {
        var idx = node.children.length;
        evt.preventDefault();
        evt.stopPropagation();
        addItem(idx);
      ...
      $nodeid
        .off("click", '> .jsonform-tabbable > .nav-tabs > li > a > ._jsonform-array-item-delete')
        .on('click', '> .jsonform-tabbable > .nav-tabs > li > a > ._jsonform-array-item-delete', function (e) {
        e.preventDefault();
        e.stopPropagation();
