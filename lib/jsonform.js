...
jsonform.elementTypes = {
      ...
      if (global.Picker) {
        ...
        if (node.isReadOnly()) {
          _.extend(sppecturmOpts, {
              beforeShow: function(color) {return false;}
          });
        }
      ...
      var setup = function () {
        ...
        $(node.el).find('#' + escapeSelector(node.id)).wysihtml5({
          "toolbar": {
            ...
            "fa": node.ownerTree.defaultClasses.iconClassPrefix.slice(-2) === 'fa' ? true : false
          },
          "events": {
            "load": function () {
  ...
  'summernote':{
    ...
    'onInsert': function (evt, node) {
      var setup = function () {
        ...
        if (node.ownerTree.defaultClasses.iconClassPrefix.slice(-2) === 'fa') {
          _.extend(summernoteOpts, {
              "icons": {
                "align": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-align-left\"/>",
                "alignCenter": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-align-center\"/>",
                "alignJustify": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-align-justify\"/>",
                "alignLeft": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-align-left\"/>",
                "alignRight": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-align-right\"/>",
                "indent": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-indent\"/>",
                "outdent": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-outdent\"/>",
                "arrowsAlt": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-arrows-alt\"/>",
                "bold": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-bold\"/>",
                "caret": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-caret-down\"/>",
                'circle': "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-circle\"/>",
                "close": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-times\"/>",
                "code": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-code\"/>",
                "eraser": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-eraser\"/>",
                //"font": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-font note-recent-color\"/>", // font icon used in color picer is broken - use default
                "italic": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-italic\"/>",
                "link": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-link\"/>",
                "unlink": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-unlink\"/>",
                "magic": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-magic\"/>",
                "menuCheck": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-check\"/>",
                "minus": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-minus\"/>",
                "orderedlist": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-list-ol\"/>",
                "pencil": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-pencil-alt\"/>",
                "picture": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-image\"/>",
                "question": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-question\"/>",
                "redo": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-redo\"/>",
                "square": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-square\"/>",
                "strikethrough": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-strikethrough\"/>",
                "subscript": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-subscript\"/>",
                'superscript': "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-superscript\"/>",
                "table": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-table\"/>",
                'textHeight': "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-text-height\"/>",
                "trash": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-trash-alt\"/>",
                "underline": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-underline\"/>",
                "undo": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-undo\"/>",
                "unorderedlist": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-list-ul\"/>",
                "video": "<i class=\"" + node.ownerTree.defaultClasses.iconClassPrefix + "-film\"/>"
              }
          });
        }
  ...
  'imageselect': {
    'template': '<div>' +
      ...
      '<div class="dropdown">' +
      '<a class="btn <%= cls.buttonClass %>" data-toggle="dropdown" href="#"<% if (node.value) { %> style="max-width:<%= width %>px;max-height:<%= height %>px"<% } %>>' +
      ...
      $(node.el).on('click', '.dropdown-menu a', function (evt) {
        ...
        if (value) {
          ...
          $(node.el).find('a[data-toggle="dropdown"]')
            ...
            .html('<img class="' + node.ownerTree.defaultClasses.imgResponsiveClass + '" src="' + (!value.match(/^https?:/) ? prefix : '') + value + suffix + '" alt="" />')
            .dropdown('hide');
        }
        else {
  ...
  'iconselect': {
    'template': '<div>' +
      '<input type="hidden" name="<%= node.name %>" id="<%= node.id %>" value="<%= value %>" />' +
      '<div class="dropdown">' +
        '<a class="btn <%= cls.buttonClass %>" data-toggle="dropdown" href="#">' +
    ...
    'onInsert': function (evt, node) {
      $(node.el).on('click', '.dropdown-menu a', function (evt) {
        ...
        var elt = node.formElement || {};
        var isFaIcon = node.ownerTree.defaultClasses.iconClassPrefix.slice(-2) === 'fa' ? true : false;
        if (value) {
          if (value.indexOf(node.ownerTree.defaultClasses.iconClassPrefix) === 0) {
            value = value.substring(node.ownerTree.defaultClasses.iconClassPrefix.length+1);
          }
          if (isFaIcon) {
          ...
          $(node.el).find('input').attr('value', value);
          $(node.el).find('a[data-toggle="dropdown"]')
            .html('<i class="' + node.ownerTree.defaultClasses.iconClassPrefix + '-' + value + (isFaIcon ? ' fa-fw' : '') + '" alt="" />')
            .dropdown('hide');
        }
        else {
          $(node.el).find('input').attr('value', '');
  ...
  'radiobuttons': {
    ...
    'onInsert': function (evt, node) {
      ...
      if (elt.activeClass) {
        ...
        activeClass += ' ' + node.ownerTree.defaultClasses.buttonClass;
      }
      $(node.el).find('label.btn').on('click', function () {
        $(this).parent().find('label.btn').removeClass(activeClass).addClass(node.ownerTree.defaultClasses.buttonClass);
        $(this).removeClass(node.ownerTree.defaultClasses.buttonClass).addClass(activeClass);
  ...
  'checkboxbuttons': {
    ...
    'onInsert': function (evt, node) {
      var elt = node.formElement || {};
      var activeClass = elt.activeClass || node.ownerTree.defaultClasses.buttonClass;
      $(node.el).find('label.btn').on('click', function () {
        if ($(this).find('input:checkbox').prop('checked')) {
          $(this).removeClass(node.ownerTree.defaultClasses.buttonClass);
          $(this).toggleClass(activeClass, true);
        } else {
          $(this).toggleClass(activeClass, false);
          $(this).addClass(node.ownerTree.defaultClasses.buttonClass);
        }
      }).find(':checked').closest('label.btn').addClass(activeClass);
    }
  },
  'array': {
    ...
    'onInsert': function (evt, node) {
      ...
      var addItem = function (idx) {
        ...
        if (node.ownerTree.defaultClasses.useTooltip) {
          initializeTooltip();
        }
    ...
    'onInsert': function (evt, node) {
      ...
      var updateTabs = function (selIdx) {
        ...
        _.each(node.children, function (child, idx) {
          ...
          tabs += '<li class="tabwrap ' + node.ownerTree.defaultClasses.navItemClass + '" data-idx="' + idx + '">' +
                  '<a class="draggable tab ' + node.ownerTree.defaultClasses.navLinkClass + '" data-toggle="tab" rel="' + escape(title) + '">' +
                  escapeHTML(title);
          if (!node.isReadOnly()) {
            tabs += ' <span href="#" class="_jsonform-array-item-delete"><i class="' +
              node.ownerTree.defaultClasses.iconClassPrefix + '-trash" title="Remove item"></i></span>' +
              '</a>';
          }
          tabs += '</li>';
        });
        if (!node.isReadOnly() && (boundaries.maxItems < 0 || node.children.length < boundaries.maxItems)) {
          tabs += '<li class="tabwrap ' + node.ownerTree.defaultClasses.navItemClass + '" data-idx="-1"><a class="tab ' + node.ownerTree.defaultClasses.navLinkClass + ' _jsonform-array-addmore" title="'+(node.formElement.addMoreTooltip ? escapeHTML(node.formElement.addMoreTooltip) : 'Add new item')+'"><i class="' +
            node.ownerTree.defaultClasses.iconClassPrefix + '-plus"></i> '+(node.formElement.addMoreTitle || 'New')+'</a></li>';
        }
  ...
  'tabs':{
    'template':'<ul class="nav <%= cls.navTabsClass %> <%= elt.htmlClass?elt.htmlClass:"" %>"' +
    '<% if (elt.id) { %> id="<%= elt.id %>"<% } %>' +
    '><%=tab_list%></ul><div style="clear: both;"></div><div class="tab-content" <% if (elt.id) { %> data-tabset="<%= elt.id %>"<% } %>><%=children%></div>',
    'getElement': function (el) {
      return $(el).parent().get(0);
    },
    'onBeforeRender': function (data, node) {
      ...
      _.each(node.children, function (child, idx) {
        ...
        tab_list += '<li class="tabwrap ' + node.ownerTree.defaultClasses.navItemClass +
          ((idx === 0) ? ' active' : '') + '">' +
          '<a href="#'+ parentID + title_escaped +'" class="tab ' + node.ownerTree.defaultClasses.navLinkClass + ((idx === 0) ? ' active' : '') + '"' +
          ' data-tab="' + parentID + title_escaped + '"' +
          ' data-toggle="tab">' + title +
          (child.formElement && child.formElement.addIcon ? '<i class="' + node.ownerTree.defaultClasses.iconClassPrefix + '-' + child.formElement.addIcon + '"></i>' : '') +
          '</a></li>';
      });
  ...
  'question': {
    ...
    'onInsert': function (evt, node) {
      ...
      $(node.el).find('input[type="radio"]').on('change', function (evt) {
        ...
        $(node.el).find("label.btn").addClass(node.ownerTree.defaultClasses.buttonClass);
        $(this).closest("label.btn").removeClass(node.ownerTree.defaultClasses.buttonClass);
...
formNode.prototype.enhance = function () {
  ...
  if (this.formElement) {
    ...
    if (this.el) {
      ...
      if (this.onChange)
        $(this.el).on('change', function(evt) { node.onChange(evt, node); });
      if (this.view.onChange)
        $(this.el).on('change', function(evt) { node.view.onChange(evt, node); });
      if (this.formElement.onChange)
        $(this.el).on('change', function(evt) { node.formElement.onChange(evt, node); });

      if (this.onInput)
        $(this.el).on('input', function(evt) { node.onInput(evt, node); });
      if (this.view.onInput)
        $(this.el).on('input', function(evt) { node.view.onInput(evt, node); });
      if (this.formElement.onInput)
        $(this.el).on('input', function(evt) { node.formElement.onInput(evt, node); });

      if (this.onClick)
        $(this.el).on('click', function(evt) { node.onClick(evt, node); });
      if (this.view.onClick)
        $(this.el).on('click', function(evt) { node.view.onClick(evt, node); });
      if (this.formElement.onClick)
        $(this.el).on('click', function(evt) { node.formElement.onClick(evt, node); });

      if (this.onKeyUp)
        $(this.el).on('keyup', function(evt) { node.onKeyUp(evt, node); });
      if (this.view.onKeyUp)
        $(this.el).on('keyup', function(evt) { node.view.onKeyUp(evt, node); });
      if (this.formElement.onKeyUp)
        $(this.el).on('keyup', function(evt) { node.formElement.onKeyUp(evt, node); });

      if (handlers) {
        _.each(handlers, function (handler, onevent) {
          if (onevent !== 'insert') {
            $(this.el).on(onevent, function(evt) { handler(evt, node); });
          }
        }, this);
      }
    }
...
formTree.prototype.initialize = function (formDesc) {
  ...
  jsonform.defaultClasses = getDefaultClasses();
  ...
  function convertSchemaV3ToV4(schema) {
    if (schema) {
      ...
      if (schema.dependencies) {
        for (var field in schema.dependencies) {
          if (typeof schema.dependencies[field] === 'string') {
            schema.dependencies[field] = [schema.dependencies[field]];
          }
        }
      }
    ...
    Object.keys(obj).forEach(function(prop, index, array){
      ...
      if (depth === 0 && prop === '$ref' && def !== null && typeof def === 'string') {
        if (def.slice(0, 14) === '#/definitions/') {
          var ref = def.replace(/^#\/definitions\//, '');
...
formTree.prototype.validate = function(noErrorDisplay) {
  ...
  if (options.validate!==false) {
    ...
    if (validator) {
      ...
      if (this.formDesc._validatorVendor == 'ajv') {
        ...
        var v = validator.validate(values, this.formDesc._originalSchemaV4);
...
$.fn.jsonFormErrors = function(errors, options) {
  ...
  for (var i = 0; i < errors.length; i++) {
    ...
    if (form.formDesc._validatorVendor === 'ajv') {
      ...
      var key = errors[i].dataPath || errors[i].instancePath;
      ...
      var key = errors[i].uri || errors[i].path || errors[i].dataPath;
    }
    if (key) {
      if (form.formDesc._validatorVendor === 'ajv') {
  ...
  $errorInvisiblePanels.each(function() {
    var $this = $(this);
    $errorTabs = $errorTabs.add($this.closest('.jsonform-tabbable').find('> .nav > li').eq($this.index()).addClass(form.defaultClasses.groupMarkClassPrefix + 'error'));
  });
...
$.fn.jsonForm = function(options, param1) {
  ...
  // init tooltips
  if (form.defaultClasses.useTooltip) {
    initializeTooltip();
  }
