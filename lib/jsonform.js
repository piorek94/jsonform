...
jsonform.fieldTemplate = function(inner) {
  return '<div ' +
    ...
    '<div<% if (cls.controlClass) { %> class="<%= cls.controlClass %>"<% } %>>' +
      '<% if (node.description) { %>' +
        '<span class="<%= cls.helpClass %> jsonform-description"><%= node.description %></span>' +
      '<% } %>' +
      ...
      inner +
      '<% } %>' +
      '<span class="<%= cls.helpClass %> jsonform-errortext" style="display:none;"></span>' +
    '</div></div>';
};
...
jsonform.elementTypes = {
  ...
  'help': {
    'template':'<span <%= id ? \'id="\' + id + \'"\' : "" %> class="<%= cls.helpClass %>" style="padding-top:5px"><%= node.helpvalue || elt.helpvalue %></span>',
    'fieldtemplate': true
  },
  'msg': {
    'template': '<%= elt.msg %>'
