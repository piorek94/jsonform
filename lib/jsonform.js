      ...
      var setup = function () {
        ...
        if (node.ownerTree.defaultClasses.iconClassPrefix.slice(-2) === 'fa') {
          _.extend(summernoteOpts, {
              "icons": {
                "align": "<i class=\"fa fa-align-left\"/>",
                "alignCenter": "<i class=\"fa fa-align-center\"/>",
                "alignJustify": "<i class=\"fa fa-align-justify\"/>",
                "alignLeft": "<i class=\"fa fa-align-left\"/>",
                "alignRight": "<i class=\"fa fa-align-right\"/>",
                "indent": "<i class=\"fa fa-indent\"/>",
                "outdent": "<i class=\"fa fa-outdent\"/>",
                "arrowsAlt": "<i class=\"fa fa-arrows-alt\"/>",
                "bold": "<i class=\"fa fa-bold\"/>",
                "caret": "<i class=\"fa fa-caret-down\"/>",
                'circle': "<i class=\"fa fa-circle\"/>",
                "close": "<i class=\"fa fa-times\"/>",
                "code": "<i class=\"fa fa-code\"/>",
                "eraser": "<i class=\"fa fa-eraser\"/>",
                //"font": "<i class=\"fa fa-font note-recent-color\"/>", // font icon used in color picer is broken - use default
                "italic": "<i class=\"fa fa-italic\"/>",
                "link": "<i class=\"fa fa-link\"/>",
                "unlink": "<i class=\"fa fa-unlink\"/>",
                "magic": "<i class=\"fa fa-magic\"/>",
                "menuCheck": "<i class=\"fa fa-check\"/>",
                "minus": "<i class=\"fa fa-minus\"/>",
                "orderedlist": "<i class=\"fa fa-list-ol\"/>",
                "pencil": "<i class=\"fa fa-pencil-alt\"/>",
                "picture": "<i class=\"fa fa-image\"/>",
                "question": "<i class=\"fa fa-question\"/>",
                "redo": "<i class=\"fa fa-redo\"/>",
                ...
                'textHeight': "<i class=\"fa fa-text-height\"/>",
                "trash": "<i class=\"fa fa-trash-alt\"/>",
                "underline": "<i class=\"fa fa-underline\"/>",
                "undo": "<i class=\"fa fa-undo\"/>",
                "unorderedlist": "<i class=\"fa fa-list-ul\"/>",
                "video": "<i class=\"fa fa-film\"/>"
              }
          });
        }
