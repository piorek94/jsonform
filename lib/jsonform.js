        ...
        $(node.el).find('#' + escapeSelector(node.id)).wysihtml5({
          ...
          "events": {
            "load": function () {
              ...
              $(this.editableElement).removeAttr('required');
            }
          }
        });
      };
  ...
  'iconselect': {
    'template': '<div>' +
      ...
      '<div class="dropdown">' +
        ...
        '<div class="dropdown-menu" id="<%= node.id %>_dropdown">' +
          '<div>' +
          '<% _.each(node.options, function(key, idx) { if ((idx > 0) && ((idx % columns) === 0)) { %></div><div><% } %><a class="btn<% if (buttonClass) { %> <%= buttonClass %><% } %>" ><% if (key instanceof Object) { %><i class="<%= cls.iconClassPrefix %>-<%= key.value %><% if (isFaIcon) { %> fa-fw<% } %>" alt="<%= key.title %>" /></a><% } else { %><i class="<%= cls.iconClassPrefix %>-<%= key %><% if (isFaIcon) { %> fa-fw<% } %>" alt="" /><% } %></a> <% }); %>' +
          '</div>' +
          '<div class="<%= cls.placementClassPrefix %>-right"><a class="<%= cls.buttonClass %>">Reset</a></div>' +
        '</div>' +
      '</div>' +
  ...
  'tabarray': {
    ...
    'onInsert': function (evt, node) {
      ...
      var updateTabs = function (selIdx) {
        ...
        $('> .jsonform-tabbable > .nav-tabs [data-toggle="tab"]', $nodeid).eq(selIdx).click();
      };
      ...
      //$('> a._jsonform-array-addmore, > .jsonform-tabbable > .nav-tabs > li > ._jsonform-array-addmore', $nodeid).click(function (evt) {
