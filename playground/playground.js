    ...
    form: [
      {
        ...
        titleMap: {
          ...
          'schema-references': 'JSON Schema - references',
          'schema-root-reference': 'JSON Schema - root schema reference',
          'schema-simple': 'JSON Schema - simple single field form',
          ...
          'fields-numeric': 'Fields - Numeric: the numeric types(integer/number)',
          ...
          'fields-tab-array-constraints' : 'Fields - Arrays with/without tabs: items constraints',
          ...
          'fields-null': 'Fields - Null field: the null type',
